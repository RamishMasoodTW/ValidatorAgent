...
async function runInstaller() {
  console.clear();
  console.log(BANNER);
  console.log(source_default.cyan.bold("  Welcome to the Frontend Git Quality & AI Gatekeeper Setup Wizard!\n"));
  console.log(source_default.white("  This installer will configure a global Git pre-push hook and set up"));
  console.log(source_default.white("  Gemini 2.5 Flash AI-powered regression audits across all your repositories.\n"));
